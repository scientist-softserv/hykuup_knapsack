...
RSpec.feature 'Create a MobiusGenericWork', js: false do
  context 'a logged in user' do
    ...
    scenario do
      ...
      # choose "payload_concern", option: "MobiusGenericWork"
      # click_button "Create work"

      expect(page).to have_content "Add New Mobius generic work"
      ...
      # its element
      find('body').click
      choose('mobius_generic_work_visibility_open')
