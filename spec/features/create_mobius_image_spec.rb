...
RSpec.feature 'Create a MobiusImage', js: false do
  context 'a logged in user' do
    ...
    scenario do
      ...
      # choose "payload_concern", option: "MobiusImage"
      # click_button "Create work"

      expect(page).to have_content "Add New Mobius image"
      ...
      # its element
      find('body').click
      choose('mobius_image_visibility_open')
